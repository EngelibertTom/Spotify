...
<article class="leaderboard__profile">
      ...
      <span class="leaderboard__name"><span class="song-title"><a href="#" class="song" data-file="{{$s->url}}">{{$s['title']}}</a></span> posted by <span class="song-artist"><a href="/users/{{ $s->user->id }}">{{ $s->user->name }}</a></span></span>
